...
const S: Record<string, React.CSSProperties> = {
  ...
  btn:       { background: "linear-gradient(135deg, #8e1616 0%, #6b1010 100%)", border: "none", color: "#fff",
  ...
  btnLoading:{ background: "rgba(142,22,22,0.28)", border: "none", color: "rgba(255,255,255,0.7)",
